...
def checkTableSettings(conn):
    ...
    checkSettingExists(conn, 'Nats_server', 'nats://localhost:4222')
    checkSettingExists(conn, 'Nats_sub_topic', 'sub.topic')
    checkSettingExists(conn, 'Nats_pub_topic', 'pub.topic')
